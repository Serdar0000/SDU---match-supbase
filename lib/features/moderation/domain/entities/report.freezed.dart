...
mixin _$Report {
 ...
 String get id; String get reporterId; String get reportedId; String get reason; String? get details; DateTime get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,reporterId,reportedId,reason,details,createdAt);

@override
String toString() {
  return 'Report(id: $id, reporterId: $reporterId, reportedId: $reportedId, reason: $reason, details: $details, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String reporterId, String reportedId, String reason, String? details, DateTime createdAt
});
...
/// Create a copy of Report
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? reporterId = null,Object? reportedId = null,Object? reason = null,Object? details = freezed,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String reporterId,  String reportedId,  String reason,  String? details,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Report() when $default != null:
return $default(_that.id,_that.reporterId,_that.reportedId,_that.reason,_that.details,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String reporterId,  String reportedId,  String reason,  String? details,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _Report():
return $default(_that.id,_that.reporterId,_that.reportedId,_that.reason,_that.details,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String reporterId,  String reportedId,  String reason,  String? details,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _Report() when $default != null:
return $default(_that.id,_that.reporterId,_that.reportedId,_that.reason,_that.details,_that.createdAt);case _:
  return null;
...
class _Report implements Report {
  const _Report({required this.id, required this.reporterId, required this.reportedId, required this.reason, this.details, required this.createdAt});
...
/// Create a copy of Report
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? reporterId = null,Object? reportedId = null,Object? reason = null,Object? details = freezed,Object? createdAt = null,}) {
